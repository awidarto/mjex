    ...
    @if($shop)
      ...
      @if(isset( $shop->useImage) )
        @if($shop->useImage == 'linked')
          ...
          <div class="text-center">
            <img style="width:85%;height:auto !important;" class="text-center" src="{{$shop->extImageURL }}" alt="{{ $shop->merchantname}}" />
          </div>
        ...
        @else
          ...
          @if(isset($shop->defaultpictures) && is_array($shop->defaultpictures) && isset($shop->defaultpictures['medium_url']) )
            <div class="text-center">
              <img style="width:85%;height:auto !important;" class="text-center" src="{{$shop->defaultpictures['medium_url']}}" alt="{{ $shop->merchantname}}" />
            </div>
          @endif
